...
class DummyData {
    ...
    private func seedUserProfile() {
        userProfile.append(UserProfile(id: 0,
                                       ...
                                       gender : .male,
                                       avatar: UIImage(named: "avatar-0") ?? UIImage(),
        ...
        userProfile.append(UserProfile(id: 1,
                                       ...
                                       dob: Date(timeInterval: -(60*60*24*365)*30, since: Date()),
                                       gender: .female,
                                       avatar: UIImage(named: "avatar-1") ?? UIImage(),
        ...
        userProfile.append(UserProfile(id: 2,
                                       ...
                                       dob: Date(timeInterval: -(60*60*24*365)*30, since: Date()),
                                       gender: .male,
                                       avatar: UIImage(named: "avatar-2") ?? UIImage(),
        ...
        userProfile.append(UserProfile(id: 3,
                                       ...
                                       dob: Date(timeInterval: -(60*60*24*365)*30, since: Date()),
                                       gender: .male,
                                       avatar: UIImage(named: "avatar-4") ?? UIImage(),
        ...
        userProfile.append(UserProfile(id: 4,
                                       ...
                                       dob: Date(timeInterval: -(60*60*24*365)*30, since: Date()),
                                       gender: .female,
                                       avatar: UIImage(named: "avatar-5") ?? UIImage(),
        ...
        userProfile.append(UserProfile(id: 5,
                                       ...
                                       dob: Date(timeInterval: -(60*60*24*365)*30, since: Date()),
                                       gender: .male,
                                       avatar: UIImage(named: "avatar-3") ?? UIImage(),
        ...
        userProfile.append(UserProfile(id: 6,
                                       ...
                                       dob: Date(timeInterval: -(60*60*24*365)*30, since: Date()),
                                       gender: .male,
                                       avatar: UIImage(named: "avatar-6") ?? UIImage(),
